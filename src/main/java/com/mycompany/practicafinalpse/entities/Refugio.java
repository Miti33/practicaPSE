...
@NamedQueries({
    ...
    @NamedQuery(name = "Refugio.findByDomicilio", query = "SELECT r FROM Refugio r WHERE r.domicilio = :domicilio"),
...
public class Refugio implements Serializable {
    ...
    public Refugio(String email, String cif, String domicilio, String telefono) {
        this.email = email;
        this.cif = cif;
    ...
    public String toString() {
        return "com.mycompany.practicafinalpse.entities.Refugio[ email=" + email + " ]";
    }
