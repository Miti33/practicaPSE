...
public class Cliente implements Serializable {
    ...
    public Cliente(String email, String apellidos, String nif, String domicilio, String telefono, Date fechaNacimiento) {
        this.email = email;
    ...
    public String toString() {
        return "com.mycompany.practicafinalpse.entities.Cliente[ email=" + email + " ]";
    }
